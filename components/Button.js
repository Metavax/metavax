	...
	return (
		<>
			{props.link === undefined ? (
				<button onClick={props.funcName} id={props.id} className='banger relative select-none bg-no-repeat bg-cover bg-center flex justify-center items-center hover:scale-105 transform transition-all duration-300 ease-in-out'>
