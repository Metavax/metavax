...
const RarityRow = (props) => {
	return (
		<>
			<div className='flex flex-col justify-between py-3 text-center border-b-2 border-solid border-secondary sm:border-black sm:flex-row last:border-none last:pb-0'>
				<p className='mb-0 text-xl sm:text-black'>{props.left}</p>
				<p className='mb-0 text-xl sm:text-black'>{props.right}</p>
			</div>
		</>
	);
};
	...
	return (
		<>
			<div id='rarity' className='pt-36'>
				...
				<div className='grid grid-cols-1 gap-16 lg:grid-cols-2 auto-rows-auto'>
					<div className='flex flex-col items-center justify-center'>
						<div className='relative'>
							<div className='hidden sm:block'>
								<Image src={frame} alt='Rarity Info' />
							</div>
							<div className='top-0 left-0 z-10 flex flex-col justify-center w-full h-full p-12 sm:absolute items-between'>
